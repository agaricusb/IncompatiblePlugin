...
public class SamplePlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        net.minecraft.server.v1_5_R3.PlayerConnection playerConnection = null;
        try {
        ...
        for (int i = 0; i < Item.byId.length; i++) {
            ...
            net.minecraft.server.v1_5_R3.Block nmsBlock = i < 4096 ? net.minecraft.server.v1_5_R3.Block.byId[i] : null;
        ...
        // test un-renamed map
        System.out.println("net.minecraft.server.v1_5_R3.MinecraftServer.currentTick = "+MinecraftServer.currentTick);

        // test bouncycastle is available
        System.out.println("bouncycastle="+net.minecraft.v1_5_R3.org.bouncycastle.asn1.bc.BCObjectIdentifiers.class);



        System.out.println("SNOW.id="+net.minecraft.server.v1_5_R3.Block.SNOW.id);
        ...
        net.minecraft.server.v1_5_R3.WorldServer worldServer = ((CraftWorld)Bukkit.getServer().getWorlds().get(0)).getHandle();
